...
async fn test_app_new_async_behavior() {
    ...
    let result = tokio::time::timeout(Duration::from_secs(10), app_future).await;
    ...
    match result {
        ...
        Err(_) => {
            panic!("App::new() should complete within 10 seconds");
        }
    }
}
...
async fn test_app_new_with_timeout() {
    ...
    tokio::select! {
        ...
        _ = tokio::time::sleep(Duration::from_secs(15)) => {
            ...
            panic!("App::new() should complete within 15 seconds");
        }
    }
}
