...
mod re_export_tests {
    ...
    fn test_ios_devices_re_export() {
        // Test numeric constants that are re-exported
        use emu::constants::IOS_DEVICE_PARSE_BATCH_SIZE;
...
mod module_accessibility_tests {
    ...
    fn test_module_specific_imports() {
        ...
        assert_eq!(
            errors::ERR_LIST_ANDROID_DEVICES,
    ...
    fn test_nested_module_imports() {
        ...
        assert_eq!(
            android::CMDLINE_TOOLS_LATEST_BIN,
            "cmdline-tools/latest/bin"
        );
        assert_eq!(errors::ERROR_PREFIX, "Error:");
        assert_eq!(
            msg_errors::ANDROID_SDK_NOT_FOUND,
...
mod constants_module_documentation_tests {
    ...
    fn test_module_organization() {
        ...
        assert_eq!(
            constants::defaults::DEFAULT_RAM_MB,
            constants::DEFAULT_RAM_MB
        );
