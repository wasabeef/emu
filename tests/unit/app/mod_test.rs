//! Unit tests for app/mod.rs focusing on basic functionality and state management
//!
//! This file combines unit tests from app_mod_minimal_test.rs and basic tests
//! from app_mod_comprehensive_test.rs, removing duplicates.
...
/// Test App::new() initialization and state setup (consolidated)
#[tokio::test]
